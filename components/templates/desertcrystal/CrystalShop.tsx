...
const { contract } = useContract( CRYSTAL_ADDRESS);
  ...
  <div className="w-full justify-center mx-auto pt-24 px-8 ">
    <h1 className="text-yellow-100 text-2xl font-semibold font-Jost text-center">To access the Desert Crystal Shop, you will need to own a SKY GODZ Founders NFT!</h1>
    <p className="text-white text-lg font-Jost text-center py-4 ">You currently do not own a SKY GODZ Founders NFT. Head over to the NFT mint page, claim a Founders NFT to play the game.</p>
